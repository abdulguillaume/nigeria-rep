...
{
    public partial class lkp_stigma_toward
    {
        ...
        private void Fixupiom_ward_profile(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.lkp_stigma_toward, this))
                    {
                        item.lkp_stigma_toward = null;
                    }
                }
            }
        }
        ...
        private void Fixupiom_ward_profile1(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                foreach (iom_ward_profile item in e.OldItems)
                {
                    if (ReferenceEquals(item.lkp_stigma_toward1, this))
                    {
                        item.lkp_stigma_toward1 = null;
                    }
                }
            }
        }
        ...
        private void Fixupiom_ward_profile2(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                foreach (iom_ward_profile item in e.OldItems)
                {
                    if (ReferenceEquals(item.lkp_stigma_toward2, this))
                    {
                        item.lkp_stigma_toward2 = null;
                    }
                }
            }
        }
