    ...
    public class B3FController : Controller
    {
        ...
        public ActionResult Create(B3F b3f)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    _entity.iom_group_assessment_1.Add(ga_p1);//Add(ga_p1);
                    _entity.SaveChanges();
        ...
        public ActionResult CreateP2(iom_group_assessment_2 p2)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    _entity.iom_group_assessment_2.Add(ga_p2);//Add(ga_p2);
                    _entity.SaveChanges();
                ...
                try
                {
                    ...
                    foreach (var a in s.sites)
                    {
                        ...
                        if(a.notEmpty)
                        {
                            ...
                            _entity.iom_ga_site_information.Add(site);// Add(site);
                            //_entity.SaveChanges();
                        }
                    }
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    foreach (var a in s.hh_ages)
                    {
                        ...
                        _entity.iom_ga_gender_age_sample.Add(bd);// Add(bd);
                        i++;
                ...
                try
                {
                    ...
                    foreach (var a in b3f.ga_idp_pop)
                    {
                        if (a.notEmpty)
                        {
                            ...
                            _entity.iom_ga_idp_population.Remove(u);// Remove(u);
                        }
                    }
                    ...
                    foreach (var a in toRemInf)
                    {
                        ...
                        _entity.iom_ga_informants.Remove(u);// Remove(u);
                    ...
                    foreach (var a in s.sites)
                    {
                       ...
                       // else if (!string.IsNullOrEmpty(a.name_site) && a.id == 0)
                        ...
                        else if(!a.notEmpty && a.id!=0)
                        {
                            //delete blank ones
                            iom_ga_site_information x = ga_p1.iom_ga_site_information.Where(y => y.id == a.id).FirstOrDefault();
                            _entity.iom_ga_site_information.Remove(x);// Remove(x);
                        }
                    }
        ...
        public ActionResult Delete(int id, FormCollection collection)
        {
            ...
            if (ga_p1 != null)
            {
                try
                {
                    ...
                    _entity.iom_group_assessment_1.Remove(ga_p1);// Remove(ga_p1);
        ...
        public ActionResult DeleteP2(int id, FormCollection collection)
        {
            ...
            if (ga_p2 != null)
            {
                ...
                {
                    // TODO: Add delete logic here
                    _entity.iom_group_assessment_2.Remove(ga_p2);// Remove(ga_p2);
        ...
        public ActionResult DeleteP3(int id, FormCollection collection)
        {
            ...
            if (sites != null)
            {
                try
                {
                    ...
                    foreach (var a in sites)
                    {
                        _entity.iom_ga_site_information.Remove(a);// Remove(a);
                        _entity.SaveChanges();
                    }
        ...
        public ActionResult DeleteP4(int id, FormCollection collection)
        {
            ...
            if (ages != null)
            {
                try
                {
                    ...
                    {
                        _entity.iom_ga_gender_age_sample.Remove(a);// Remove(a);
                        _entity.SaveChanges();
                    }
