...
namespace DTM_Nigeria.Models
{
    ...
    public partial class iom_b1f_organizations_assisting
    {
        ...
        private void Fixupiom_organizations(iom_organizations previousValue)
        {
            ...
            {
                if (!iom_organizations.iom_b1f_organizations_assisting.Contains(this))
                {
                    iom_organizations.iom_b1f_organizations_assisting.Add(this);
                }
        ...
        private void Fixupiom_profile(iom_profile previousValue)
        {
            ...
            if (iom_profile != null)
            {
                if (!iom_profile.iom_b1f_organizations_assisting.Contains(this))
                {
                    iom_profile.iom_b1f_organizations_assisting.Add(this);
                }
